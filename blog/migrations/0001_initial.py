    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('og_image', models.ImageField(blank=True, null=True, upload_to='media/seo_blog_images/')),
                ...
                ('twitter_image', models.ImageField(blank=True, null=True, upload_to='media/seo_blog_images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blog_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blog_categories', to='blog.blogcategory')),
                ('blog_heading', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blog_headings', to='blog.blogheading')),
            ],
        ),
        migrations.CreateModel(
            name='BlogInnerPage',
            fields=[
                ...
                ('description', models.TextField()),
                ('slug', models.CharField(blank=True, max_length=200, null=True, unique=True)),
                ('blog', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inner_descriptions', to='blog.blogs')),
            ],
        ),
    ]
